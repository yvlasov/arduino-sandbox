...
void loop()
{
    ...
    */
    /*
    long gx = GY85.raw_gyro_x( GY85.readGyro() );
    Serial.println  ( GY85.raw_gyro_x( GY85.readGyro() ) );
    */
    Serial.println  ( GY85.accelerometer_x( GY85.readFromAccelerometer() ) );
    
    //delay(1);             // only read every 0,5 seconds, 10ms for 100Hz, 20ms for 50Hz
}
