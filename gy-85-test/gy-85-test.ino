...
void setup()
{
    ...
    initGyro();
    Serial.begin(115200);
    delay(1000);    // Open Notepad (or similar) and make sure it has the focus
...
void loop()
{
  ...
  Serial.print(readAccelerometer(ADXL345_X));
  Serial.print(readAccelerometer(ADXL345_Y));
  Serial.print(readAccelerometer(ADXL345_Z));
  delay(1000);
  readMagnetometer();
  Serial.print(magX);
  Serial.print(magY);
